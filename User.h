...
class User
{
  typedef   std::shared_ptr<RecommendationSystem> recommendation_system_ptr;

 private:
  const std::string _user_name;
  rank_map _user_ranking;
  recommendation_system_ptr _recommendation_system_ptr;
...
public:
	 ...
	 */
	User(const std::string& user_name, rank_map& user_ranking,
         recommendation_system_ptr& rec_system );
     ...
     * @return
     */
    rank_map get_ranks() const {return _user_ranking;}
